...
st.markdown("Comprehensive analysis and visualization of oceanic data from ARGO floats .. For zero latency in the time of presentation , we are running our app on 2 floats and 50,000 measurements")
